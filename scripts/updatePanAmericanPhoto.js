/**
 * updatePanAmericanPhoto.js — Updates the gym photo for Pan American Recreation Center.
 *
 * Downloads the photo from the source URL, uploads it to Firebase Storage,
 * then updates the imageUrl field on the Firestore gym document.
 *
 * Usage (from RunCheck project root):
 *   node scripts/updatePanAmericanPhoto.js
 *
 * Requires:
...
// ── Config ────────────────────────────────────────────────────────────────────
const GYM_ID      = 'pan-american-recreation-center';
...
const PHOTO_URL    = 'https://s3-media0.fl.yelpcdn.com/bphoto/JrTyWaLFSsdyb9JY3PJNuw/348s.jpg';
...
async function run() {
  ...
  console.log('\n✅  Done! Pan American Recreation Center photo updated.\n');
  process.exit(0);
}
