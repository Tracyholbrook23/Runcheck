/**
 * uploadGoldsGymHestersPhoto.js — Updates the gym photo for Gold's Gym Hester's Crossing.
 *
 ...
 *   node scripts/uploadGoldsGymHestersPhoto.js
 *
 * Requires:
...
// ── Config ────────────────────────────────────────────────────────────────────
const GYM_ID       = 'golds-gym-hesters-crossing';
...
const PHOTO_URL    = 'https://lh3.googleusercontent.com/p/AF1QipP3Eq4JkVM8I8eK-ZHK1dBVY_pTN5vBijWz2KV3=w243-h174-n-k-no-nu';
...
async function run() {
  ...
  console.log("\n✅  Done! Gold's Gym Hester's Crossing photo updated.\n");
  process.exit(0);
}
