...
const gyms = [
  ...
  },
  {
    ...
    defaultRunLevel: 'competitive',
    notes: '',
    imageUrl: 'https://storage.googleapis.com/runcheck-567a3.firebasestorage.app/gymImages/lifetime-austin-north/cover.jpg',
    placeId: 'ChIJe_Eb3H_NRIYRkKtd_qO5sR4',
    website: 'https://www.lifetime.life/locations/tx/austin-north.html',
    photoGallery: [
      'https://storage.googleapis.com/runcheck-567a3.firebasestorage.app/gymImages/lifetime-austin-north/cover.jpg',
    ],
  ...
  },
  {
    ...
    defaultRunLevel: 'mixed',
    notes: '',
    imageUrl: 'https://storage.googleapis.com/runcheck-567a3.firebasestorage.app/gymImages/golds-gym-hesters-crossing/cover.jpg',
    placeId: 'ChIJ0XJHM-DRRIYRMfHwrKVYdfA',
    website: 'https://www.goldsgym.com/austinhesterscrossingtx/',
    photoGallery: [
      'https://storage.googleapis.com/runcheck-567a3.firebasestorage.app/gymImages/golds-gym-hesters-crossing/cover.jpg',
    ],
  ...
  },
  {
    ...
    defaultRunLevel: 'mixed',
    notes: '',
    imageUrl: 'https://storage.googleapis.com/runcheck-567a3.firebasestorage.app/gymImages/fitness-connection-austin-north/cover.jpg',
  ...
  imageUrl: 'https://storage.googleapis.com/runcheck-567a3.firebasestorage.app/gymImages/house-of-gainz-austin/cover.jpg',
  placeId: 'ChIJSzyHR2bPRIYRDLB2KuvpSnU',
  website: 'https://houseofgainz.com/',
  photoGallery: [
    'https://storage.googleapis.com/runcheck-567a3.firebasestorage.app/gymImages/house-of-gainz-austin/cover.jpg',
  ],
  location: {
  ...
  },
  {
    ...
    defaultRunLevel: 'mixed',
    notes: 'Austin Parks & Recreation indoor basketball courts',
    imageUrl: 'https://storage.googleapis.com/runcheck-567a3.firebasestorage.app/gymImages/parque-zaragoza-recreation-center/cover.jpg',
    photoGallery: [
      'https://storage.googleapis.com/runcheck-567a3.firebasestorage.app/gymImages/parque-zaragoza-recreation-center/cover.jpg',
    ],
  ...
  // ── Suburbs ──
  {
    ...
    defaultRunLevel: 'mixed',
    notes: 'Indoor basketball gym, fitness center',
    imageUrl: 'https://storage.googleapis.com/runcheck-567a3.firebasestorage.app/gymImages/georgetown-recreation-center/cover.jpg',
...

  {
    ...
    address: '2291 Research Dr, Okemos, MI 48864',
    city: 'Okemos',
    state: 'MI',
    zip: '48864',
    type: 'indoor',
    ...
    imageUrl: 'https://lh3.googleusercontent.com/gps-cs-s/APNQkAF6Q0W4Rv2tZwCUaOb682cc7vaHEBp7zEK5KZZn83aYM13IzMFeX6LHuQuz60Kk51MvI7SLZHULQmJT1dzEFiizxhCusBoHgQRFDExjht-SFo87fbWoJtYRCQRVK0O8DQ-rmzs=w243-h304-n-k-no-nu',
    photoGallery: [
      'https://lh3.googleusercontent.com/gps-cs-s/APNQkAF6Q0W4Rv2tZwCUaOb682cc7vaHEBp7zEK5KZZn83aYM13IzMFeX6LHuQuz60Kk51MvI7SLZHULQmJT1dzEFiizxhCusBoHgQRFDExjht-SFo87fbWoJtYRCQRVK0O8DQ-rmzs=w243-h304-n-k-no-nu',
    ],
    // Coordinates verified 2026-04-19 (corrected from 42.7183, -84.4077)
    location: { latitude: 42.70536236156866, longitude: -84.43527622883583 },
    checkInRadiusMeters: 200,
    autoExpireMinutes: 120,
  },
  {
    ...
    imageUrl: 'https://storage.googleapis.com/runcheck-567a3.firebasestorage.app/gymImages/court-one-north-lansing/cover.jpg',
    photoGallery: [
      'https://storage.googleapis.com/runcheck-567a3.firebasestorage.app/gymImages/court-one-north-lansing/cover.jpg',
    ],
    // Coordinates verified 2026-04-19 (corrected from 42.7620, -84.5276)
    location: { latitude: 42.76221509189624, longitude: -84.52766840185082 },
    checkInRadiusMeters: 200,
    autoExpireMinutes: 120,
  },
  {
    ...
    type: 'indoor',
    accessType: 'paid',
    status: 'archived', // ⚠️ Facility permanently closed — The Summit Sports and Ice Complex shut 2021; original Centerline Dr building sold for industrial use
    defaultRunLevel: 'competitive',
  ...
  {
    id: 'msu-im-west',
    name: 'IM West — Michigan State University',
    ...
    status: 'active',
    defaultRunLevel: 'competitive',
    notes: 'MSU intramural sports facility west of Spartan Stadium — indoor courts including basketball. MSU student ID or rec membership required to enter.',
    // Coordinates verified 2026-04-19 (corrected from 42.728937919446814, -84.48711206994257)
    location: { latitude: 42.72904384119816, longitude: -84.4870783518538 },
    checkInRadiusMeters: 200,
    autoExpireMinutes: 120,
  },

  {
    id: 'club-chandler-crossings',
    name: 'The Club at Chandler Crossings',
    address: '3850 Coleman Rd, East Lansing, MI 48823',
    city: 'East Lansing',
    state: 'MI',
    zip: '48823',
    type: 'indoor',
    ...
    status: 'active',
    defaultRunLevel: 'competitive',
    notes: 'The Club at Chandler Crossings — indoor basketball courts; free to residents and community members',
    imageUrl: 'https://storage.googleapis.com/runcheck-567a3.firebasestorage.app/gymImages/club-chandler-crossings/cover.jpg',
    photoGallery: [
      'https://storage.googleapis.com/runcheck-567a3.firebasestorage.app/gymImages/club-chandler-crossings/cover.jpg',
    ],
    // Coordinates verified 2026-04-19
    location: { latitude: 42.77254580224525, longitude: -84.48743187233903 },
    checkInRadiusMeters: 200,
    autoExpireMinutes: 120,
  },
  ...
  {
    id: 'msu-im-circle',
    name: 'IM Circle — Michigan State University',
    ...
    status: 'active',
    defaultRunLevel: 'competitive',
    notes: 'MSU intramural sports facility northeast of Spartan Statue — indoor basketball courts. MSU student ID or rec membership required to enter.',
    // Coordinates verified 2026-04-19 via Google Maps
    location: { latitude: 42.73186045039393, longitude: -84.48576466431427 },
    checkInRadiusMeters: 200,
    autoExpireMinutes: 120,
  },
  {
    id: 'msu-im-east',
    name: 'IM East — Michigan State University',
    address: '804 E Shaw Ln, East Lansing, MI 48825',
    city: 'East Lansing',
    state: 'MI',
    zip: '48825',
    type: 'indoor',
    ...
    status: 'active',
    defaultRunLevel: 'competitive',
    notes: 'MSU intramural sports facility on the east side of campus between Shaw Lane and Wilson Rd — indoor basketball courts. MSU student ID or rec membership required to enter.',
    // Coordinates verified 2026-04-19 (corrected from 42.7265, -84.4688)
    location: { latitude: 42.72486771111098, longitude: -84.46863263059338 },
    checkInRadiusMeters: 200,
    autoExpireMinutes: 120,
  },
...

  {
    ...
    address: '5825 Wise Rd, Lansing, MI 48911',
    city: 'Lansing',
    state: 'MI',
    zip: '48911',
    type: 'indoor',
    ...
    // Coordinates verified 2026-04-19 (corrected from 42.7201, -84.5793; address corrected from 1619 Reo Ave)
    location: { latitude: 42.67375028615337, longitude: -84.59064418650749 },
    checkInRadiusMeters: 200,
    autoExpireMinutes: 120,
  },
  {
    ...
    // Coordinates verified 2026-04-19 (corrected from 42.7349, -84.5172)
    location: { latitude: 42.73490618661223, longitude: -84.51713142959308 },
    checkInRadiusMeters: 200,
    autoExpireMinutes: 120,
  },
  {
    ...
    address: '2400 Hall St, Lansing, MI 48906',
    city: 'Lansing',
    state: 'MI',
    zip: '48906',
    type: 'indoor',
    ...
    // Coordinates verified 2026-04-19 (corrected from 42.6877, -84.5815; address corrected from 2411 W Holmes Rd)
    location: { latitude: 42.75961453221193, longitude: -84.54496044322202 },
    checkInRadiusMeters: 200,
    autoExpireMinutes: 120,
  },
...

  {
    ...
    imageUrl: 'https://storage.googleapis.com/runcheck-567a3.firebasestorage.app/gymImages/hannah-community-center-east-lansing/cover2.jpg',
    photoGallery: [
      'https://storage.googleapis.com/runcheck-567a3.firebasestorage.app/gymImages/hannah-community-center-east-lansing/cover2.jpg',
    ],
    // Coordinates verified 2026-04-19 (corrected from 42.74165416356866, -84.4856027307667)
    location: { latitude: 42.741307465197565, longitude: -84.48562418977875 },
    checkInRadiusMeters: 200,
    autoExpireMinutes: 120,
  },
  ...
  },
  {
    ...
    status: 'archived',
    defaultRunLevel: 'casual',
    notes: 'City of Lansing park — archived 2026-04-19 pending court verification',
  ...
  },
  {
    ...
    status: 'archived',
    defaultRunLevel: 'casual',
    notes: 'City of Lansing park on the Grand River — basketball court unconfirmed; archived 2026-04-19 pending verification',
  ...
  // Batch 9 — Added 2026-04-26: Additional Lansing outdoor courts
  {
    id: 'slater-park-lansing',
    name: 'Slater Park',
    address: '2700 Mark Ave, Lansing, MI 48912',
    city: 'Lansing',
    state: 'MI',
    zip: '48912',
    type: 'outdoor',
    ...
    status: 'active',
    defaultRunLevel: 'mixed',
    notes: 'Outdoor basketball courts at Slater Park — free public access',
    imageUrl: 'https://lh3.googleusercontent.com/gps-cs-s/APNQkAGSUXnPUH8B6iqV7WYzUqvkJKncFwNADpODOMouytCFc4GfzstvHHrZ0x1PngRuUj23bCGE-E4GRkwtIM9bfIewluroU4rSDFXjE0uFifED9jPcIuLOSnPmzJKtTNZn7UBzhiPm=s677-k-no',
    photoGallery: [
      'https://lh3.googleusercontent.com/gps-cs-s/APNQkAGSUXnPUH8B6iqV7WYzUqvkJKncFwNADpODOMouytCFc4GfzstvHHrZ0x1PngRuUj23bCGE-E4GRkwtIM9bfIewluroU4rSDFXjE0uFifED9jPcIuLOSnPmzJKtTNZn7UBzhiPm=s677-k-no',
    ],
    location: { latitude: 42.750483805769676, longitude: -84.51448973557316 },
    checkInRadiusMeters: 150,
    autoExpireMinutes: 120,
  },
  {
    id: 'foster-park-lansing',
    name: 'Foster Park',
    address: '2401 Marcus St, Lansing, MI 48912',
    city: 'Lansing',
    state: 'MI',
    zip: '48912',
    type: 'outdoor',
    ...
    status: 'active',
    defaultRunLevel: 'mixed',
    notes: 'Outdoor basketball courts at Foster Park — free public access',
    imageUrl: 'https://www.lansingstatejournal.com/gcdn/-mm-/dc1d3e5e65b152bee0a905a0841ef5aec5b9385d/c=0-134-2000-1264/local/-/media/2015/11/02/MIGroup/Lansing/635820782515804651-WarmNovember-2.JPG?width=660&height=373&fit=crop&format=pjpg&auto=webp',
    photoGallery: [
      'https://www.lansingstatejournal.com/gcdn/-mm-/dc1d3e5e65b152bee0a905a0841ef5aec5b9385d/c=0-134-2000-1264/local/-/media/2015/11/02/MIGroup/Lansing/635820782515804651-WarmNovember-2.JPG?width=660&height=373&fit=crop&format=pjpg&auto=webp',
    ],
    location: { latitude: 42.729262037329356, longitude: -84.51732271142157 },
    checkInRadiusMeters: 150,
    autoExpireMinutes: 120,
  },
];
